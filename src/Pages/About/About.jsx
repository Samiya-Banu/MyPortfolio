      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-6 for-col left-side">
            ...
            <h2 className="heading text-capitalize">i am Samiya</h2>
            <p className="for-text text-capitalize first-para">
              welcome to my portfolio . i am Samiya, a passionate web developer
              specializing in MERN stack technologies: MongoDB, Express.js React
              and Node.js. With a keen eye for detail and a commitment to
            ...
            <div className="forBtn">
              ...
              <Link to="" className="for-button about-btn">
                Learn More
              </Link>
            </div>
          </div>
